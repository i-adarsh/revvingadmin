...
export const ADVANCE_DURATIONS = [
  { name: 'This months', value: 'this_month' },
  { name: 'Last month', value: 'last_4_weeks' },
  { name: 'Last 3 months', value: 'last_12_weeks' },
  { name: 'Year to date', value: 'year_to_date' }
];

export const DURATIONS = [
  { name: 'Last 1 month', value: 'last_4_weeks' },
  { name: 'Last 3 months', value: 'last_12_weeks' },
  { name: 'Last 6 months', value: 'last_26_weeks' },
  { name: 'Year to date', value: 'year_to_date' }
];

export const TRANS_DURATIONS = [
  { name: 'Last 1 month', value: 'last_4_weeks' },
  { name: 'Last 3 months', value: 'last_12_weeks' },
  { name: 'Last 6 months', value: 'last_26_weeks' },
  { name: 'Year to date', value: 'year_to_date' }
...
export const TRANSACTIONS_TYPE = [
  { name: 'Advance', value: 'purchase', content: 'lorem ipsum tooltip' },
  { name: 'Collection', value: 'collection', content: 'lorem ipsum tooltip' },
  { name: 'Surplus Distribution', value: 'surplus_distribution', content: 'lorem ipsum tooltip' }
];
export const STATUS_TYPE = [
  { name: 'Open', value: 'Open', content: 'lorem ipsum tooltip' },
  { name: 'Closed', value: 'Closed', content: 'lorem ipsum tooltip' },
  { name: 'Overdue', value: 'Overdue', content: 'lorem ipsum tooltip' }
];

// Type Tooltip list
export const TYPE_TOOLTIP = [
  { name: 'Revenue Advanced', value: 'Revenue Advanced' },
  {
    name: 'Total payment received from a revenue source',
    value: 'Total payment received from a revenue source'
  },
  { name: 'Repayment of Revving advances', value: 'Repayment of Revving advances' },
  { name: 'Fees charged on Revving advances', value: 'Fees charged on Revving advances' },
  {
    name: 'Reimbursement of excess funds collected after repayment of Revving advances and fees',
    value: 'Reimbursement of excess funds collected after repayment of Revving advances and fees'
  }
];
